...
export default function Hero() {
  return (
    <div className="w-full h-96 bg-[url('https://images.unsplash.com/photo-1509785307050-d4066910ec1e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1328&q=80')] bg-cover bg-center flex justify-center items-center">
      <main>
        <div className="flex flex-col justify-center items-center bg-black/50 p-10">
          ...
          <p className="mt-5 text-center text-lg text-white opacity-70">
            Don't queue to pay, or wait in line for your order to be ready.<br/> Order online while you get to the shop, pick it up and go!
          </p>
