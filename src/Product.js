...
const product = {
  ...
  addOn: [
    { name: 'Cocoa', class: 'bg-yellow-900', selectedClass: 'ring-gray-400', inStock: true },
    { name: 'Cinnamon', class: 'bg-yellow-400', selectedClass: 'ring-gray-400', inStock: true },
    { name: 'Milk', class: 'bg-white', selectedClass: 'ring-gray-900', inStock: true },
  ],
}
                    ...
                    <div className="sm:col-span-8 lg:col-span-7">
                      ...
                      <section aria-labelledby="options-heading" className="mt-10">
                        ...
                        <form>
                                        ...
                                        {size.inStock ? (
                                          <span
                                            className={classNames(
                                              ...
                                              checked ? 'border-yellow-900' : 'border-transparent',
                          ...
                          {/* addOn */}
                          <div className="mb-10">
                            <h4 className="text-sm font-medium text-gray-900">Add On</h4>

                            <RadioGroup value={selectedAddOn} onChange={setSelectedAddOn} className="mt-4">
                              <RadioGroup.Label className="sr-only"> Choose a Add On </RadioGroup.Label>
                              <div className="grid grid-cols-4 gap-4">
                                {product.addOn.map((addOn) => (
                                  ...
                                  >
                                    {({ active, checked }) => (
                                      <>
                                        <RadioGroup.Label as="span">{addOn.name}</RadioGroup.Label>
                                        {addOn.inStock ? (
                                          <span
                                            className={classNames(
                                              active ? 'border' : 'border-2',
