  ...
  return (
    <Popover className="relative bg-white">
      <div className="flex items-center justify-between border-b-2 border-gray-100 py-6 px-2">
        <div className="flex justify-start md:w-0 text-base font-medium text-gray-500 hover:text-gray-900">
        ...
        <div className="hidden items-center justify-end md:flex md:w-0">
          <NavLink
            to="/login"
      ...
      >
        ...
        >
          <div className="divide-y-2 divide-gray-50 rounded-md bg-white shadow-md ring-1 ring-black ring-opacity-5">
              ...
              <div className="flex items-center justify-between">
                ...
                {cartQuantity > 0 && (
                  <button className="relative">
                    <i className="fa-solid fa-mug-hot items-center text-2xl md:text-3xl text-yellow-900"></i>
                    <div className="flex items-center justify-center px-2 py-1 text-xs leading-none font-bold text-yellow-900 bg-yellow-400 rounded-full absolute right-0 bottom-0 translate-y-2/4 translate-x-2/4">
                      {cartQuantity}
                    </div>
                  </button>
                )}
